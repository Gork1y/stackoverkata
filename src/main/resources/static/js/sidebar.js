...
sidebar.className = 'left-sidebar js-pinned-left-sidebar ps-relative';
sidebar.innerHTML += `
            ...
            <ol class="nav-links">
                ...
                <li class="ps-relative  youarehere" aria-current="true">
                    <a href="/" class="pl8 js-gps-track nav-links--link"
                        ...
                        aria-controls="" data-controller="" data-s-popover-placement="right" aria-current="page"
                    ...
                    <ol class="nav-links">
                        ...
                        <li class="ps-relative" aria-current="false">
                            <a id="nav-questions" href="/questions"
                                ...
                                aria-current="false" data-s-popover-auto-show="true"
                        ...
                        <li class="ps-relative" aria-current="false">
                            <a id="nav-unanswered" href="/unanswered" class=" js-gps-track nav-links--link"
...
elem.insertAdjacentElement('afterbegin', sidebar);
